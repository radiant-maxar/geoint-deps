...
#  * gcore/tiff_srs.py: PROJ version too old
#  * gdrivers/openfilegdb.py:
#     `RuntimeError: Checksum value could not be computed due to I/O read error`
#  * gdrivers/pdf.py: Crash with JPX compression.
#  * gdrivers/rmf.py: NumPy version too old
#  * gdrivers/webp.py: WebP version too old
...
addopts =
    ...
    --color=no
    --strict-markers
    --deselect gcore/rasterio.py::test_rasterio_rms_halfsize_downsampling_float
    --deselect gcore/tiff_ovr.py::test_tiff_ovr_46
    --deselect gcore/tiff_read.py::test_tiff_read_corrupted_jpeg_cloud_optimized
...
export PYTHONPATH=%{buildroot}%{python3_sitearch}:/usr/local/lib/python%{python3_version}/site-packages:/usr/local/lib64/python%{python3_version}/site-packages:%{python3_sitearch}
