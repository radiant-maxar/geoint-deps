...
The [`mapserver.spec`](../SPECS/el9/mapserver.spec) file originate from [Fedora's `mapserver` RPM](https://src.fedoraproject.org/rpms/mapserver) and are released under the [Fedora license](./licenses/Fedora-LICENSE).
